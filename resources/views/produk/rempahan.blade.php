...
<div class="small-container">
    <h2 class="title">Semua Rempah-rempah</h2>
{{-- Form Pencarian & Sort --}}
<form method="GET" action="{{ route('produk.kategori.rempah') }}" class="mb-4 d-flex gap-2">
    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari rempah-rempah..." class="form-control" style="max-width: 250px;">
