...
<div class="small-container">
    <h2 class="title">Produk Buah</h2>
{{-- Form Pencarian & Sort --}}
<form method="GET" action="{{ route('produk.kategori.buah') }}" class="mb-4 d-flex gap-2">
    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari buah-buahan..." class="form-control" style="max-width: 250px;">
